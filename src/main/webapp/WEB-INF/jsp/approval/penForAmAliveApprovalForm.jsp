...
<html>
    <head>
        <title>
            <c:out value="${roleBean.staffTypeName}"/>s Awaiting Am Alive Resolution
        </title>
		...
		<script language="JavaScript">
        		    ...
        		    jQuery('#selectall').click(function(event) {  //on click
        		        ...
        		        var url = 'viewApproveRejectAmAlive.do?checkboxState='+(isChecked?"true":"false");
        		    ...
        		    jQuery(".selectableCheckbox").click(function(e ){
        		    	var url = 'viewApproveRejectAmAlive.do?checkboxState='+(this.checked?"true":"false") //use can use true or false also
        				+"&reqList="+this.id;
                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    Pending <c:out value="${roleBean.staffTypeName}"/> Am Alive Approval
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="90%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label"><c:out value="${roleBean.staffTypeName}"/>(s) Awaiting Am Alive Approval for Payroll Processing</p>
                                            ...
                                            <a href="${appContext}/approveAmAliveForPayroll.do?aid=${empAppr.id}" class="popper" data-popbox="pop${empAppr.id}">
                              			         	${empAppr.employeeId}
                              			        </a>
