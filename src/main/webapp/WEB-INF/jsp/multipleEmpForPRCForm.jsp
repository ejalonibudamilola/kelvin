                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td>
                                            <a href='${appContext}/searchEmpForEdit.do'><i>Search again</i></a>                                    
                                        </td>
                                    ...
                                    <tr>
                                        <td valign="top">
											...
											<display:column property="employeeId" title="${roleBean.staffTitle}" media="html" href="${appContext}/generatePRC.do" paramId="eid" paramProperty="id"></display:column>
