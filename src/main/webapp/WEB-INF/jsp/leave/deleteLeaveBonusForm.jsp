...
<html>
<head>
<title> Delete Leave Bonus Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Delete Leave Bonus</div>
						</td>
					</tr>
					<tr>
						...
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td width="25%">
										<form:input path="miniBean.mdaInfo.name" size="50" maxlength="20" disabled="true"/>
									</td>
								</tr>
								<tr>
									<td align="right" width="35%" nowrap>
								...
								<tr>
									...
									<td width="25%">
										<form:input path="createdBy" size="50" maxlength="50" disabled="true"/>										
									</td>
								</tr>
									<c:choose>
										...
										<c:otherwise>
										 ...
										 <tr>
											...
											<td width="25%">
												<form:input path="approvedBy" size="15" maxlength="15" disabled="true"/>										
											</td>
										 </tr>
										 <tr>
											<td align="right" width="35%" nowrap>
						...
						<td class="buttonRow" align="right" >
						           <c:choose>
							         	...
							         	<c:otherwise>
							         			...
							         			<input type="image" name="submit" value="approve" title="Delete Leave Bonus" class="" src="images/delete_h.png">&nbsp;
