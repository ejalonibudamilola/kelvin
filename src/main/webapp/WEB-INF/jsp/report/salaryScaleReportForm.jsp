...
<html>
<head>
<title><c:out value="${miniBean.displayTitle}"/></title>
...
<body class="main">
	...
	<table class="main" width="70%" border="1" bordercolor="#33c0c8" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
			...
			<tr>
				<td colspan="2">
					<div class="title"><c:out value="${miniBean.displayTitle}"/></div>
				</td>
			</tr>
			<tr>
					...
					<tr style="${miniBean.showRow}">
                        ...
                        <display:table name="dispBean" id="salaryScale" class="display table" export="false" sort="page" defaultsort="1" requestURI="${appContext}/viewSalaryStructure.do">
                            <%--<display:caption>Staffs on <font color="blue"><c:out value="${miniBean.salaryStructureName}"/></font> Pay Scale</display:caption>--%>
                            ...
                            <display:column property="parentObjectName" title="${roleBean.mdaTitle}"></display:column>
					...
					<tr style="${miniBean.showRow}">
						<td>
						    <div class="reportBottomPrintLink">
								<a href="${appContext}/salaryScaleByLevelExcel.do?ssid=${miniBean.id}&fl=${miniBean.fromLevel}&tl=${miniBean.toLevel}" title='View/Export to Microsoft Excel'>
