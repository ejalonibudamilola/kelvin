	...
	<tr>
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<a href="${appContext}/singleBusinessExecSummaryReport.do?fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}&rt=1">
				View in Excel </a> &nbsp;&nbsp;<a href="${appContext}/singleBusinessExecSummaryReport.do?fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}&rt=2" target="_blank">View In Pdf</a>
				<br />
				</div>
				...
				<a href="${appContext}/singleBusinessExecSummaryReport.do?fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}&rt=1">
				View in Excel </a> &nbsp;&nbsp; |  &nbsp;&nbsp;<a href="${appContext}/singleBusinessExecSummaryReport.do?fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}&rt=2">View In Pdf</a>
                 <br />
				</div>
