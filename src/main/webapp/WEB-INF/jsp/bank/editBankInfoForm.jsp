...
<html>
<head>
<title> Edit Bank Information Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Edit Bank Information</div>
						</td>
					</tr>
					<tr>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Edit <c:out value="${bankBean.name}"/> </td>
					</tr>
					<tr>
						<td class="activeTD">
								...
								<tr>
									...
									<td width="25%">
                                            <form:select path="mfbInd">
														...
														<form:option value="1" title="Deposit Money Banks i.e.,Skye Bank,First Bank, GT Bank et al">Deposit Money Bank</form:option>
