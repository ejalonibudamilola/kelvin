...
<html>
    ...
    <form:form modelAttribute="dedTypeBean">
                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    <c:out value="${roleBean.staffTypeName}"/> Deduction Types<br>
                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                <div id="topOfPageBoxedErrorMessage" style="display:${dedTypeBean.displayErrors}">
									<spring:hasBindErrors name="dedTypeBean">
										<ul>
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label"><c:out value="${roleBean.staffTypeName}"/> Deduction Types</p>
											<display:table name="dispBean" id="deductionTbl" class="display table" export="" sort="page" defaultsort="1" requestURI="${appContext}/viewDeductionTypes.do">
											<display:setProperty name="export.rtf.filename" value="StaffDeductionTypeList.rtf"/>
											<display:setProperty name="export.excel.filename" value="StaffDeductionTypeList.xls"/>
											<display:column property="name" title="Name" media="html" href="${appContext}/editDeductionType.do" paramId="dtid" paramProperty="id"></display:column>
