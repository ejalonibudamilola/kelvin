...
<html>
<head>
<title> Search Subvention Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
								<div class="title"> Search for a Subvention </div>
						</td>
				...
				<form:form modelAttribute="empMiniBean">
						<div id="topOfPageBoxedErrorMessage" style="display:${empMiniBean.displayErrors}">
