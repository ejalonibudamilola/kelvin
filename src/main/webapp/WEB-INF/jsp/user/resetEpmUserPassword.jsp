		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Reset Password for an existing user</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="activeTD" align="center">
							<table border="0" cellspacing="0" cellpadding="2">
                                ...
                                <tr>
					              <td align=right nowrap><span class="required"><b>User Email :</b></span></td>
					              <td width="25%">
										&nbsp;<c:out value="${epmUser.email}" />
								   </td>
					              <td align="left"></td>
					            </tr>
					            <tr>
					...
					<tr>
						<td class="buttonRow" align="right" >
						   <c:choose>
						   	...
						   	<c:otherwise>
						   	   <input type="image" name="submit" value="ok" alt="Ok" class="" src="images/resetpasswd.png">&nbsp;
