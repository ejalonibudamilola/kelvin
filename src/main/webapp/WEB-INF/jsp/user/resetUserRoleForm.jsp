		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Change Role <c:out value="${epmUser.firstName}" />&nbsp;<c:out value="${epmUser.lastName}" /></div>
						</td>
					</tr>
					<tr>
				...
				<div id="topOfPageBoxedErrorMessage" style="display:${epmUser.displayErrors}">
						...
						<td class="activeTD" align="center">
							<table border="0" cellspacing="0" cellpadding="2">
					            ...
					            <tr>
					              ...
					              <td>   
					                &nbsp;<c:out value="${epmUser.role.name}" /></td>
					              <td align="left"></td>
					            </tr>
					            <tr>
					              <td align=right width="35%" nowrap><span class="required">New Role*</span></td>
					              <td>   
					                <form:select path="roleId">
					                <form:option value="-1">&lt;Assign Role&gt;</form:option>
					...
					<tr>
						<td class="buttonRow" align="right" >
						   <c:choose>
						   	...
						   	<c:otherwise>
						   		<input type="image" name="submit" value="ok" title="Change Role" class="" src="images/changeRole.png">&nbsp;
