...
<html>
<head>
<title> Un-lock User Account Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Unlock an existing locked account</div>
						</td>
					</tr>
					<tr>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Locked Account</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="buttonRow" align="right" >
						    <c:choose>
                        	    ...
                        	    <c:otherwise>
							        <input type="image" name="submit" value="ok" title="Ok" class="" src="images/activate.png">&nbsp;
