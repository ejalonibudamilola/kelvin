...
<html>
<head>
<title> Edit Relationship Type Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Edit Relationship Type</div>
						</td>
					</tr>
					<tr>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Edit <c:out value="${relTypeBean.name}"/> </td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									<td align="right" width="35%" nowrap>
										<span class="required">Relationship Type Name*</span></td>
									<td width="25%">
										<form:input path="name" size="25" maxlength="20"/>
									</td>
								</tr>
					           </table>							
						</td>
					...
					<tr>
						...
						<c:otherwise>
							<input type="image" name="submit" value="ok" title="Edit Relationship Type" class="" src="images/ok_h.png">&nbsp;
