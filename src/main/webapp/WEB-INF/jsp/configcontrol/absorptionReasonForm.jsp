							...
							<table border="0" cellspacing="1" cellpadding="2">
								...
								<tr>
									<td align="right" nowrap>
										<span class="required">Absorption Reason*</span>&nbsp;
									</td>
					 ...
					 <tr>
                                    ...
                                    <tr>
                                        <td valign="top">
											...
											<display:table name="dispBean" id="absorptiontbl" class="display table" export="false" sort="page" defaultsort="1" requestURI="${appContext}/editAbsorptionReason.do">
											<display:column property="name" title="Absorption Reason" media="html" href="${appContext}/editAbsorptionReason.do" paramId="cid" paramProperty="id"></display:column>
