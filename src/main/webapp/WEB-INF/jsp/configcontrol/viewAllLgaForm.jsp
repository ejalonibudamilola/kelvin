...
<html>
    ...
    <body class="main">
    <form:form modelAttribute="lgaBean">
	<c:set value="${lgaList}" var="dispBean" scope="request"/>
                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
									<div id="topOfPageBoxedErrorMessage" style="display:${displayErrors}">
                                    								 <spring:hasBindErrors name="lgaBean">
                                             							 <ul>
								...
								<tr align="left">
                                 ...
                                 <!--   <tr>
                                       <td class="activeTD">
                                        ...
                                        <td class="activeTD">
                                            <form:input path="recordCode" size="5" maxlength="10"/>
                                        </td>
                                    </tr> -->
									<tr>
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                         <c:if test="${lgaBean.showOverride eq true}">
                                    <td class="buttonRow" align="right">
								 ...
								 <c:if test="${lgaBean.showOverride eq true}">
                                    <tr>
                                        <td valign="top">
											...
											<display:table name="dispBean" id="lgaTbl" class="display table" export="" sort="page" defaultsort="1" requestURI="${appContext}/viewAllLga.do">
											...
											<display:column property="name" title="Name" media="html" href="${appContext}/editLga.do" paramId="lgId" paramProperty="id"></display:column>
											<display:column property="name" title="Name" media="excel"></display:column>
											<display:column property="recordCode" title="Record Code"></display:column>
