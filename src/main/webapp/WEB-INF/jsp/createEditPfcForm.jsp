			...
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						* = required<br/><br/>
				<form:form modelAttribute="pfcBean">
				<div id="topOfPageBoxedErrorMessage" style="display:${displayErrors}">
								 <spring:hasBindErrors name="pfcBean">
         							 <ul>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">PFC Information</td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									<td align="right" width="35%" nowrap>
										<span class="required">PFC Name*</span></td>
									<td width="25%">
								...
								<tr>
									...
									<td width="25%">
										<form:input path="pfcCode" size="10" maxlength="10"/>
									</td>
								</tr>
								<tr>
									<td align="right" width="35%" nowrap>
