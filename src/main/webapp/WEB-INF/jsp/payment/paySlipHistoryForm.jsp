	...
	<tr align="right">
		...
		<table width="95%">
			<tr>
					...
					<td align="center"><a href='${appContext}/printSinglePayStub.do?pid=${empPayMiniBean.id}' target="_blank">Printer Friendly Version</a><span class="tabseparator">|</span><a href='${appContext}/viewPayslipHistory.do?eid=${empPayMiniBean.parentInstId}'>View History</a></td>
	...
	padding-left: 1cm;
				...
				<table width="100%" class="paycheck">
							...
							<tr>
								...
								<table width="100%">
									...
									<tr>
										...
										Pay:<u> ₦<font color="green"><c:out value="${empPayMiniBean.currentNetPayStr}" /></font>
										</u></td>
									</tr>
									<tr>
					...
					<tr>
						...
						<table class="detailsWages" width="100%" valign="top">
							<tr>
								<th class="detailsPart" align="left" title=<c:out value="${empPayMiniBean.payTypeDescr}"/>><b>Pay Group</b></th>
							...
							<tr>
								<td>
								<div ><c:out value="${empPayMiniBean.payType}"/></div></td>
								<td>
								<div align="center">
		...
		<table width="95%">
			...
			<tr>
					...
					<span class="tabseparator">|</span><a href='${appContext}/viewPayslipHistory.do?eid=${empPayMiniBean.parentInstId}'>View History</a></td>
