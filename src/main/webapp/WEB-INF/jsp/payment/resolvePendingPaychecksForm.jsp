                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left">
                                                                <tr align="left">
                                                                    <td class="activeTH">
                                                                        Pending Paychecks Found for &nbsp;<c:out value="${namedEntity.name}" />.
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td valign="top" nowrap>
                                                                                                You have Paychecks that are unapproved. Please approve or delete this paychecks before trying to create new paychecks.
																							</td>
																					   </tr>
			                                                                           <tr>
                                                                                			<td>
                                                                                   			 Click <A HREF='${appContext}/approvePaychecksForm.do' title='' id="" onclick="" >Here</A>&nbsp;to approve/delete pending paychecks.
                                                                               				 </td>
                                                                           				</tr>
