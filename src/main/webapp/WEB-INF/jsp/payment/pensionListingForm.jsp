        ...
        <table class="main" width="70%" border="1" bordercolor="#33c0c8" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                               ...
                               <br>
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr style="${miniBean.showRow}">
                                    			 <display:table name="dispBean" id="row" class="register4" sort="page" defaultsort="1" requestURI="${appContext}/bankSummary.do">
												<display:caption><c:out value="${miniBean.companyName}"/> Payroll Summary</display:caption>
												...
												<display:column property="totalPensioners" title="Number Of ${roleBean.staffTypeName}s"></display:column>
												<display:column property="cumulativeTotalPensioners" title="Cumulative ${roleBean.staffTypeName}s"></display:column>
												<display:column property="amount" title="Amount"></display:column>
												<display:column property="cumulativeTotalAmount" title="Cumulative Amount"></display:column>
				...
				<div id="excelReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/pensionListingReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=1" target="_blank">
					Pension Listing Excel&copy; </a>  <span class="tabseparator">|</span>
                   <a href="${appContext}/deceasedPensionersReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=1" target="_blank">
                   Deceased Pensioners Excel&copy;
                   </a>


				</div>
				<div id="pdfReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/pensionListingReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=2" target="_blank">
                    					Pension Listing PDF&copy; </a> <span class="tabseparator">|</span>
                    <a href="${appContext}/deceasedPensionersReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=2" target="_blank">
                    Deceased Pensioners PDF&copy;
                    </a>
				</div>
				<br>
