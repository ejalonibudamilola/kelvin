        ...
        <table class="main" width="70%" border="1" bordercolor="#33c0c8" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                               ...
                               <br>
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr style="${miniBean.showRow}">
												...
												<display:column property="lgaName" title="Local Government Name"></display:column>
												<display:column property="grossPayStr" title="Gross Pay"></display:column>
				...
				<div id="excelReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/grossSummaryReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=1" target="_blank">
					Gross Summary Excel&copy; </a>


				</div>
				<div id="pdfReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/grossSummaryReport.do?rm=${miniBean.runMonth}&ry=${miniBean.runYear}&rt=2" target="_blank">
                    					Gross Summary PDF&copy; </a>
