					...
					<tr>
						<td valign="top" class="mainBody hundredPercentWidth verticalTopAlign" id="mainbody">
							...
							<div class="container">
								...
								<div class="row">
								<div class="col-md-12">
								<!--  <div class="panel with-nav-tabs panel-default imagebgworks" style="height: 550px; "> -->
									<div class="panel with-nav-tabs panel-info" style="height: auto; ">
										<div class="panel-heading">
											<ul class="nav nav-tabs">
													<c:forEach items="${_userMenuCategories}" var="menuCat" varStatus="currStatus">
										...
										<div class="panel-body lead" style ="margin-left:10px; margin-right:10px;">
											<div class="tab-content" align="center">
												<div  class="tab-pane fade in active lead"  id="tab1default">
												   <ul class="nav nav-pills" role="tablist" style="margin : 1%;"><!--  margin previously at 1 -->
													     <c:forEach items="${_firstTabLinks}" var="menuLink">
