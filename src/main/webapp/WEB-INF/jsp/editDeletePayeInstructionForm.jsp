...
<html>
<head>
<title> Edit/Deactivate PAYE Instruction </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
								<div class="title">Edit/Deactivate PAYE Instruction</div>
						</td>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Edit/Deactivate P.A.Y.E</td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
						        ...
						        <tr>
					              ...
					              <td width="25%"><form:input path="startDateStr" disabled="true"/></td>
								</tr>
								<tr>
						         ...
						         <tr>
									...
									<td width="25%" align="left">
									  <form:radiobutton path="alterInd" value="0"/>Percentage of P.A.Y.E<br>
									  <form:radiobutton path="alterInd" value="1"/>Percentage of Monthly Basic<br></td>
								</tr>
								<tr>
