...
<title> Deleting Pending Payroll  </title>
		...
		<tr>
			<td>
				<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
						...
						<tr>
							<td align="center"><b><font color="red">Deleting Pending Paychecks.....please wait!</font></b></td>
						</tr>
						<c:choose>
							<c:when test="${progressBean.finished}">
								<tr>
									<td align="center">deleted&nbsp;&nbsp;<b><font color="blue"> <b id="counter"><c:out value="${progressBean.currentCount}"/></b> of <b id="maxRecord"><c:out value="${progressBean.totalElements}"/></b></font></b>&nbsp;&nbsp;records</td>
								</tr>
								<tr>
									<td align="center">${progressBean.displayMessage}</td>
								</tr>
							</c:when>
							<c:otherwise>
								<tr>
