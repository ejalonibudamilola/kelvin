                                    ...
                                    <tr>
                                        <td class="activeTD">
                                            <table border="0" cellspacing="0" cellpadding="2" width="100%" align="left">
                                                <tr>
                                                    <td align=right width="10%"><span class="required"><c:out value="${roleBean.staffTitle}"/>*</span></td>
                                                    <td align="left" width="90%">
                                                            ...
                                                            <input style="display:none" id="activeInd" value="<c:out value="${empMiniBean.activeInd}"/>"/>
                                                    </td>
                                                </tr>
                                                <c:if test="${not (roleBean.civilService or roleBean.subeb)}">
                                                 <tr>
                                                     ...
                                                     <td align="left" width="90%">
                                                             ...
                                                             <input style="display:none" id="legActiveInd" value="<c:out value="${empMiniBean.activeInd}"/>"/>
                                                     </td>
                                                 </tr>
