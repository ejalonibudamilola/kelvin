                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table>
                                    ...
                                    <tr>
                                       ...
                                       <tr>
                                        ...
                                        <td class="activeTD"><form:select path="id">
                              ...
                              <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label"><c:out value="${roleBean.staffTypeName}"/> Reinstatements</p>
											<display:table name="dispBean" id="reinstatetbl" class="display table" export="false" sort="page" defaultsort="1" requestURI="${appContext}/viewEmpReinstatementsLog.do">
											...
											<display:column property="mdaInfo.codeName" title="Reinstate ${roleBean.mdaTitle}"></display:column>
											<display:column property="reinstatedDateStr" title="Reinstate Date"></display:column>
											<display:column property="salaryInfo.salaryScaleLevelAndStepStr" title="Reinstate PayGroup"></display:column>
										    <display:column property="user.actualUserName" title="Reinstated By"></display:column>
                                ...
                                <c:if test="${miniBean.showLink}">
                                   		...
                                   		<div class="reportBottomPrintLink">
											<a href="${appContext}/reinstateLogExcel.do?sDate=${miniBean.fromDateStr}&eDate=${miniBean.toDateStr}&uid=${miniBean.id}&eid=${miniBean.empInstId}&mdaind=${miniBean.mdaInstId}">
