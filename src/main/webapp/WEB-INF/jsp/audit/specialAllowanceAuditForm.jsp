...
<html>
    <head>
        <title>
            Special Allowance Audit Trail Report
        </title>
                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    View Special Allowance Audit Trail<br>
                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                       ...
                                       <td class="activeTD">
                                        ...
                                        <td class="activeTD">
										 ...
										 <tr>
                                           <td class="activeTD">
											...
											<td class="activeTD"><form:select path="deductionTypeId">
														<form:option value="0">&lt;Select Allowance Type&gt;</form:option>
														<c:forEach items="${specAllowTypeList}" var="dTypeList">
										 ...
										 <tr>
                                           ...
                                           <td class="activeTD">
												<form:input path="ogNumber" maxlength="12" size="10" title="Enter Staff ID."/>
                                        </td>
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label">Special Allowance Changes</p>
											<display:table name="dispBean" id="specAllowtbl" class="display table" export="false" sort="page" defaultsort="1" requestURI="${appContext}/viewSpecialAllowanceLog.do">
											<display:setProperty name="export.rtf.filename" value="SpecialAllowanceAuditLogs.rtf"/>
											<display:setProperty name="export.excel.filename" value="SpecialAllowanceAuditLogs.xls"/>
											...
											<display:column property="allowanceType" title="Description"></display:column>
										    ...
										    <display:column property="changedBy" title="Changed By" media="html" href="${appContext}/viewUserAccountLogs.do" paramId="uid" paramProperty="user.id"></display:column>
			                         ...
			                         <c:choose>
                                   	<c:when test="${miniBean.notUsingDates}">
                                   		<div class="reportBottomPrintLink">
											<a href="${appContext}/specAllowAuditExcelND.do?uid=${miniBean.id}&stid=${miniBean.deductionTypeId}&eid=${miniBean.empInstId}">
										View All Results in Excel&copy; </a><br />			
			                        </div>
                                   	</c:when>
                                   	<c:otherwise>
                                   		<div class="reportBottomPrintLink">
											<a href="${appContext}/specAllowAuditExcel.do?uid=${miniBean.id}&sDate=${miniBean.fromDateStr}&eDate=${miniBean.toDateStr}&stid=${miniBean.deductionTypeId}&eid=${miniBean.empInstId}">
										View All Results in Excel&copy; </a><br />			
			                        </div>
			                        	</c:otherwise>
                                   </c:choose>
