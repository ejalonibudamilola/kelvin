        ...
        <table class="main" width="70%" border="1" bordercolor="#33c0c8" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                  <div id="topOfPageBoxedErrorMessage" style="display:${miniBean.displayErrors}">
									...
									<tr>
                                        <td class="activeTD">
													...
													<img src="images/calendar.png" id="fromDateId" width="16" height="16" border="0" alt="Pick a date" onclick="JACS.show(document.getElementById('fromDate'),event);"><span class="optional">&nbsp;To </span> <form:input path="toDate"/>
                                    ...
                                    <tr>
                                    	<td class="activeTD">
                                    	 Filter By <c:out value="${roleBean.mdaTitle}"/>&nbsp;<form:select path="mdaInd">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label"><c:out value="${roleBean.mdaTitle}"/> Contributory Pension</p>
											<display:table name="dispBean" class="register2" export="true" sort="page" defaultsort="1" requestURI="${appContext}/pensionReport.do">
				...
				<div id="excelReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/pensionReportByMdaExcel.do?sDate=${miniBean.fromDateStr}&eDate=${miniBean.toDateStr}&pid=${miniBean.id}&mdaid=${miniBean.mdaInd}&eid=${miniBean.empInstId}">
					Contribution Summary By <c:out value="${roleBean.mdaTitle}"/> Excel&copy; </a><span class="tabseparator">|</span>
					<a href="${appContext}/pensionReportByPFAExcel.do?sDate=${miniBean.fromDateStr}&eDate=${miniBean.toDateStr}&pid=${miniBean.id}&mdaid=${miniBean.mdaInd}&eid=${miniBean.empInstId}">
					Contribution Summary By PFA Excel&copy; </a>
					<br />
					
				</div>
				<div id="pdfReportLink" class="reportBottomPrintLink" style='display:none'>
					<a href="${appContext}/pensionContrByMdaPDF.do?sDate=${miniBean.fromDateStr}&eDate=${miniBean.toDateStr}&pid=${miniBean.id}&mdaid=${miniBean.mdaInd}&eid=${miniBean.empInstId}">
