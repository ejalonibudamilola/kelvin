...
<html>
    <head>
        <title>
            Select Configured Policy To Assign
        </title>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="90%" id="pcform0">
                                        <tr>
                                            <td>
                                                <table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left">
                                                    <tr>
                                                       <tr align="left">
                                                       <td class="activeTH">Select configured HR policy to assign</td><br/><br/>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="80%" nowrap>
                                                                                	<form:select path="id">
																						...
																						<c:forEach items="${configPolicyTypes}" var="policy">
                                        ...
                                        <tr>
                                            <td class="buttonRow" align="right">
                                                <input type="image" name='submit' value="ok"  alt='Configure' class='' src='images/create_h.png' onclick="">
