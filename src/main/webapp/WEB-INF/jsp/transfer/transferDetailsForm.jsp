...
<html>
<head>
<title> Transfer Details Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
								<div class="title">Transfer Details for: <c:out value="${miniBean.employee.displayName}"/> [ <c:out value="${miniBean.employee.employeeId}"/> ]</div>
						</td>
					</tr>
					<tr>
						...
						<td class="activeTD">
							<table width="100%" border="0" cellspacing="0" cellpadding="2">
								<tr>
						          ...
						          <tr>
						               <td align="right" width="25%"><b>Transfer Status* :</b></td>

                                            <td width="25%">
						                     <c:out value="${miniBean.approvalStatusStr}"/>
									       </td>
						          </tr>
					...
					<tr>
						<td class="buttonRow" align="right" >
						  <c:if test="${miniBean.deletable}">
						    <input type="image" name="_delete" value="delete" title="Delete Transfer Rejection" class="" src="images/delete_h.png">
						  </c:if>
