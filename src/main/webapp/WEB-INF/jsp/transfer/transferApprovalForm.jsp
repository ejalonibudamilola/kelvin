...
<html>
<head>
<title> Transfer Approval Form  </title>
						...
						<td class="activeTD">
							<table width="100%" border="0" cellspacing="0" cellpadding="2">
								<tr>
						          ...
						          <tr>
						            <td align="right" width="25%"><b>Transfer Date :&nbsp;</b></td>
						          ...
						          <c:if test="${miniBean.showOverride}">
							          <td align="right" width="25%"><b>Effective* :</b>&nbsp;</td>
							                <td width="45%" nowrap><form:radiobutton path="overrideInd" value="1" title="If 'Apply Immediately' option is selected, new ${roleBean.mdaTitle} WILL BE reflected on Pending Paychecks if they exist" />Apply Immediately <form:radiobutton path="overrideInd" value="0" title="If 'Ignore Pending Payslips' option is selected, new ${roleBean.mdaTitle} will not be reflected on Pending Paychecks if they exist"/> Ignore Pending Payslips</td>
						...
						<td class="buttonRow" align="right" >
                                        ...
                                        <c:choose>
							         	...
							         	<c:otherwise>
                                        	 ...
                                        	 <input type="image" name="_reject" value="reject" title="Reject Transfer" class="" src="images/reject_h.png">
