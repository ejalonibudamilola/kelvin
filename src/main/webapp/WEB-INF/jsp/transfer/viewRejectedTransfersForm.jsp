                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    Rejected <c:out value="${roleBean.staffTypeName}"/> Transfer
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="90%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label">Rejected <c:out value="${roleBean.staffTypeName}"/> Transfers</p>
											<display:table name="dispBean" class="register3" export="true" sort="page" defaultsort="1" requestURI="${appContext}/viewRejectedTransfers.do">
											<display:setProperty name="export.excel.filename" value="EmployeesRejectedTransferList.xls"/>
											<display:column property="employee.employeeId" title="${roleBean.staffTitle}" media="html" href="${appContext}/transferDetails.do" paramId="tid" paramProperty="id"></display:column>
                                    ...
                                    <tr>
                                       ...
                                       <input type="image" name="_delete" value="delete" title="Delete All" src="images/delete_h.png">
