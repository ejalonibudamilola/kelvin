...
<html>
<head>
<title> Edit Special Allowance Type Form  </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
								<div class="title">Edit Special Allowance Type</div>
						</td>
					</tr>
					<tr>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Edit <c:out value="${specAllowTypeBean.name}"/> </td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
                                ...
                                <tr>
									<td align="right" width="35%" nowrap>
										<span class="required">Pay As*</span>
									</td>
									<td width="25%">
										<form:select path="payTypeId">
                                ...
                                <tr>
									<td align="right" width="35%" nowrap>
										<span class="required">Salary Arrears Type*</span></td>
									<td width="25%" nowrap>
									    <form:radiobutton path="arrearsInd" value="0" />No <form:radiobutton path="arrearsInd" value="1"/> Yes
					...
					<tr>
						...
						<c:otherwise>
							<input type="image" name="submit" value="ok" title="Create Special Allowance Type" class="" src="images/ok_h.png">&nbsp;
