...
<head>
<title>Flagged Promotion Form</title>
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<div class="reportDescText">
					This report shows flagged promotions for each organization.
					<br />
				</div>
					...
					<tr>
						...
						<table class="report" cellspacing="0" cellpadding="0">
							...
							<tr class="${wBean.displayStyle}">
								...
								<td class="tableCell" align="left" valign="top"><a href="${appContext}/flaggedPromotionDetails.do?bid=${miniBean.businessClientInstId}&mid=${wBean.id}&fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}"><c:out value="${wBean.assignedToObject}"/></a></td>
								<c:forEach items="${wBean.miniBeanList}" var="mBean" varStatus="gridRow" >
									<td class="tableCell" align="right" valign="top"><c:out value="${mBean.currentValue}"/></td>
								</c:forEach>
							</tr>
							</c:forEach>
							<tr class="reportEven footer">
								...
								<c:forEach items="${miniBean.mdapFooterList}" var="footerList" varStatus="gridRow">
									<td class="tableCell" align="right"><c:out value="${footerList.currentValue}"/></td>
								</c:forEach>
							</tr>
