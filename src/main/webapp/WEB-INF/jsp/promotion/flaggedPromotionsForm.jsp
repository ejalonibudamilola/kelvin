					...
					<tr>
						...
						<table class="report" cellspacing="0" cellpadding="0">
							...
							<tr class="${wBean.displayStyle}">
								...
								<td class="tableCell" align="left" valign="top"><a href="${appContext}/flaggedPromotionsByOrganization.do?bid=${wBean.id}&fd=${miniBean.fromDateStr}&td=${miniBean.toDateStr}"><c:out value="${wBean.assignedToObject}"/></a></td>
								<c:forEach items="${wBean.miniBeanList}" var="mBean" varStatus="gridRow" >
									<td class="tableCell" align="right" valign="top"><c:out value="${mBean.countValue}"/></td>
								</c:forEach>
							</tr>
							</c:forEach>
							<tr class="reportEven footer">
								...
								<c:forEach items="${miniBean.mdapFooterList}" var="footerList" varStatus="gridRow">
									<td class="tableCell" align="right"><c:out value="${footerList.countValue}"/></td>
								</c:forEach>
							</tr>
