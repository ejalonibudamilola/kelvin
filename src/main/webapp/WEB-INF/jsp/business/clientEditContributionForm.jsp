...
<html>
<head>
<title> Setup | Create Contribution  </title>
...
function go(which) {
  n = which.value;
  if (n != 0) {
    var url = "${appContext}/clientEditContributionForm.do?cid=" + n
    location.href = url;
  }
}
						...
						<td valign="top" class="mainbody" id="mainbody">
							* = required<br/><br/>
							...
							<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
								<tr align="left">
									<td class="activeTH">Employee Deduction</td>
								</tr>
								<tr>
										...
										<table width="95%" border="0" cellspacing="0" cellpadding="2">
											<tr>
												...
												<td>
													...
													<a href="/help/popupHelp.jsp?context=faq&id=269" onClick="popupWindow('/help/popupHelp.jsp?context=faq&id=269', 'Help'); return false"><img src="images/questionmark.png" border="0"/></a>
												</td>
											</tr>
											...
											<tr>
					                			...
					                			<form:option value="${contType.id}">${contType.name}</form:option>
													...
													<a href="/help/popupHelp.jsp?context=faq&id=268" onClick="popupWindow('/help/popupHelp.jsp?context=faq&id=268', 'Help'); return false"><img src="images/questionmark.png" border="0"/></a>
												</td>
											</tr>
											<tr>
