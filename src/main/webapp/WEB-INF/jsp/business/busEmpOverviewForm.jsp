		...
		<tr>
			...
			<tr>
				<td colspan="2">
                    ...
                    <div class="title">
                       Displaying 200 Rows of <c:out value="${roleBean.staffTypeName}"/> List.
                       <a id="all" style="float:right; padding-right:10px; padding-top:5px; text-decoration:underline" href="${appContext}/busEmpOverviewForm.do?all">Click here to see all <c:out value="${roleBean.staffTypeName}"/> List</a>
                    </div>
				</td>
			</tr>
			<tr>
