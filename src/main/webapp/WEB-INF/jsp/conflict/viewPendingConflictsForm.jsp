                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="1" cellspacing="1" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label">Employee With Name Conflicts During Creation</p>
											<display:table name="dispBean" id="conflictTbl" class="display table" export="true" sort="page" defaultsort="1" requestURI="${appContext}/viewPendingConflicts.do">
											<display:setProperty name="export.rtf.filename" value="EmployeesWithNameConflictList.rtf"/>
											<display:setProperty name="export.excel.filename" value="EmployeesWithNameConflictList.xls"/>
