...
<html>
<head>
<title> PayGroup Allowance Notification Form  </title>
                                   ...
                                   <c:if test="${miniBean.approval}">
						          	<tr>
						               <td align="right" width="25%">Approval Memo* :&nbsp;</td>
									       ...
									       <td width="25%">
						                     <form:textarea path="approvalMemo" rows="5" cols="35" readonly="true"/>
									       </td>
						          ...
						          <c:if test="${miniBean.rejection}">
						          	<tr>
						               <td align="right" width="25%">Rejection Reason* :&nbsp;</td>
									       ...
									       <td width="25%">
						                     <form:textarea path="rejectionReason" rows="5" cols="35" readonly="true"/>
									       </td>
