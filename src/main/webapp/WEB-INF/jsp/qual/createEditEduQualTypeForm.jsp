...
<html>
<head>
<title> Educational Qualification Type Form</title>
		...
		<tr>
			<td>
				...
				<table border="0" cellspacing="0" cellpadding="3" width="60%" align="left" >
					<tr align="left">
						<td class="activeTH">Educational Qualification Type</td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
								...
								<tr>
									<td align="right" nowrap>
										<span class="required">Qualification Type Name*</span>&nbsp;
									</td>
								 ...
								 <tr>
									...
									<td><form:input path="codeName" size="6" maxlength="10"/></td>								
								</tr>
								 <tr>
					...
					<table>
					 <tr>
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label">Click to Edit Qualification Type</p>
											<display:table name="dispBean" class="register3" export="false" sort="page" defaultsort="1" requestURI="${appContext}/addEditQualType.do">
											<display:column property="name" title="Qualification Type" media="html" href="${appContext}/addEditQualType.do" paramId="bid" paramProperty="id"></display:column>
