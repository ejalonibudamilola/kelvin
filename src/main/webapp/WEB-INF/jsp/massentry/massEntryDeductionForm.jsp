...
<html>
    ...
    <body class="main" onload="document.massEntryDed.empId.focus()">
    <form:form modelAttribute="massDeductBean" name="massEntryDed">
	<c:set value="${massDeductBean}" var="dispBean" scope="request"/>
                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                     Create <c:out value="${roleBean.staffTypeName}"/> Deduction En Masse
                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                  <div id="topOfPageBoxedErrorMessage" style="display:${displayErrors}">
										<spring:hasBindErrors name="massDeductBean">
										<ul>
                                    ...
                                    <tr>
                                       ...
                                       <td class="activeTD">
                                        ...
                                        <td class="activeTD">
                                          ...
                                          <input style="display:none" id="activeInd" value="<c:out value="${massDeductBean.activeInd}"/>"/>
                                        </td>
                                    </tr>
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label"><c:out value="${roleBean.staffTypeName}"/> To Add Deduction</p>
											<display:table name="dispBean" class="register2" sort="page" defaultsort="1" requestURI="${appContext}/massDeductionEntry.do">
											...
											<display:column property="remove" title="Remove" href="${appContext}/massDeductionEntry.do" paramId="eid" paramProperty="id"></display:column>
                                ...
                                <c:if test="${not massDeductBean.emptyList}">
                                <tr align="left">
									<td class="activeTH">Deduction Details</td>
								</tr>
								<tr>
									<td class="activeTD">
									   <fieldset>
									   <legend><b>Enter Deduction Details</b></legend>
										<table width="100%" border="0" cellspacing="1" cellpadding="2">
											<tr>
								              <td align=right><span class="required">Select Deduction Type*</span></td>
								              <td align="left">
								                <form:select path="salaryTypeId">
								                <form:option value="-1" >&lt;Select&gt;</form:option>
								                <c:forEach items="${deductionList}" var="gtypes">
								            ...
								            <tr>
												 <td align=right><span class="required">Deduction Value*</span></td>
											...
											<tr>
												...
												<input id="addDeduction" type="image" name="_addDeduction" value="addDeduction" title="Add Deduction" class="" src="images/addDeduction.png">&nbsp;
								...
								<tr>
								   ...
								   <p></p>
								     <ul>
                                   	     <li>
                                   		    <b><font color="grey"><c:out value="${roleBean.staffTypeName}"/>s having the selected deduction will have the value overridden.</font></b>
                                   		  </li>
                                   		 <li>
                                           <b><font color="grey">If deduction is Date Dependent. Deduction will start on the next 'Pay Period'.</font></b>
                                         </li>
