...
<html>
<head>
<title>Mass Demotion By Pay Group</title>
...
<script language="JavaScript">
        		    ...
        		    jQuery('#selectall').click(function(event) {  //on click
        		        ...
        		        var url = 'massDemotionByPayGroup.do?checkboxState='+(isChecked?"true":"false");
        		    ...
        		    jQuery(".selectableCheckbox").click(function(e ){
        		    	...
        		    	var url = 'massDemotionByPayGroup.do?checkboxState='+(this.checked?"true":"false") //use can use true or false also
        				+"&reqList="+this.id;
...
<body class="main">
	...
	<table class="main" width="70%" border="1"  bordercolor="#33c0c8" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
			...
			<tr>
				<td colspan="2">
					<div class="title">Mass Demotion By Pay Group</div>
				</td>
			</tr>
			<tr>
					...
					<table>
									...
									<tr>
                                    	<td class="buttonRow" align="right">
					  						...
					  						<input type="image" name="_promote" value="promote" title="Demote ${roleBean.staffTypeName}s" class="updateReportSubmit" src="images/Save_h.png">
					                     </td>
                                    </tr>
                                     </c:if>
								</table>  
						   ...
						   <tr class="reportOdd header">
							...
							<tr class="${beans.displayStyle}">
							 <td class="tableCell" valign="top" width="5px">&nbsp;
			                 	 ...
			                 	 <input type="checkbox" name="<c:out value="${status.expression}"/>" value="true" class="selectableCheckbox" id="${beans.id}" <c:if test="${status.value}">checked</c:if>  title="Check this box to Demote ${roleBean.staffTypeName}s" />
			     				 </spring:bind>
			     			  	</td>
