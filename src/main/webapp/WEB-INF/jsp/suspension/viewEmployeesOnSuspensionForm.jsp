...
<html>
    <head>
        <title>
            Suspended <c:out value="${roleBean.staffTypeName}"/> / <c:out value="${roleBean.staffTypeName}"/> with salary stopped (Temporarily)
        </title>
                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    View Suspended <c:out value="${roleBean.staffTypeName}"/> /<br>
                                    <c:out value="${roleBean.staffTypeName}"/> with salary stopped (Temporarily)
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="90%">
                                    <tr>
                                        <td class="reportFormControls">
													...
													<img src="images/calendar.png" id="toDateId" width="16" height="16" border="0" title="Pick a date" onclick="JACS.show(document.getElementById('toDate'),event);"></td>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td valign="top">
											<p class="label">Suspended <c:out value="${roleBean.staffTypeName}"/> / <c:out value="${roleBean.staffTypeName}"/> with salary stopped (Temporarily)</p>
											<display:table name="dispBean" id="suspendedEmployee" class="display table" export="false" sort="page" defaultsort="1" requestURI="${appContext}/viewSuspendedEmployees.do">
											<display:setProperty name="export.rtf.filename" value="SuspensionList.rtf"/>
											<display:setProperty name="export.excel.filename" value="SuspensionList.xls"/>
											<display:column property="employee.employeeId" title="${roleBean.staffTitle}" media="html" href="${appContext}/reabsorbEmployee.do" paramId="eid" paramProperty="employee.id"></display:column>
										    ...
										    <display:column property="suspensionDateStr" title="Suspension Date"></display:column>
										    ...
										    <display:column property="referenceNumber" title="Ref. #"></display:column>
										     <display:column property="suspensionType.name" title="Reason"></display:column>
                      ...
                      <div class="reportBottomPrintLink">
                         <a id="reportLink" href="${appContext}/suspendedEmployeesReportExcel.do?sd=${miniBean.fromDateStr}&ed=${miniBean.toDateStr}">
                             View in Excel
                         </a><br />
                      </div>
