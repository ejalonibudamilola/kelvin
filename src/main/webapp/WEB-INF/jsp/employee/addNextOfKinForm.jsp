		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
								<div class="title">Add Next Of Kin information </div>
						</td>
					...
					<tr>
						<td class="activeTD">
							...
							<tr>
									...
									<td width="25%" nowrap>
										<b><font color="blue"><c:out value="${nokBean.parentObject.displayName}"/></font></b>
									</td>
					         ...
					         <tr>
									...
									<td width="25%">
										<b><font color="blue"><c:out value="${nokBean.parentObject.employeeId}"/></font></b>
									</td>
					          ...
					          <tr>
					            ...
					            <tr>
					              ...
					              <td align="left">   
					                ...
					                <form:option value="-1" >&lt;Select Title&gt;</form:option>
					                <c:forEach items="${cities}" var="statesList">
					                	<form:option value="${statesList.id}" title="${stateList.state.name}">${statesList.name}</form:option>
					                </c:forEach>
					                </form:select>
					              </td>
					              <td align="left"></td>
					            ...
					            <tr>
					              ...
					              <td width="25%"><form:input path="gsmNumber" size="12" maxlength="13"/></td>
					              
					            </tr>
					            <tr>
					              <td align="right">Alternate Phone Number</td>
					              <td width="25%"><form:input path="gsmNumber2" size="12" maxlength="13"/></td>
					            </tr>
					             <tr>
					              <td align="right">Email Address</td>
					              <td width="25%"><form:input path="emailAddress" size="25" maxlength="50"/></td>
					            </tr>
							</table>							
						</td>
					</tr>
