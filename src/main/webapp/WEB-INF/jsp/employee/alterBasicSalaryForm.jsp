...
<html>
<head>
<title> Alter Basic Salary Instruction Form </title>
		...
		<tr>
			<td>
				<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
								<div class="title">Create Basic Salary Instruction</div>
						</td>
				...
				<table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left" >
					<tr align="left">
						<td class="activeTH">Create Rule</td>
					</tr>
					<tr>
						<td class="activeTD">
							<table border="0" cellspacing="0" cellpadding="2">
					            ...
					            <tr>
									...
									<td width="25%" align="left">
									  <form:radiobutton path="alterDir" value="1" />Reduce Monthly Basic Salary<br>
									  <form:radiobutton path="alterDir" value="0" />Increase Monthly Basic Salary<br>
									 </td>
								...
								<tr>
									<td align="right" width="25%"><span class="required">Alteration Percentage</span></td>
									<td width="25%">
										<form:input path="alterationPercentageStr" size="7" maxlength="5" />&#37;&nbsp;e.g 50.4
									</td>	
					            </tr>
						        <tr style="${salaryBean.showForConfirm}">
					...
					<c:choose>
						<c:when test="${salaryBean.showForConfirmation}">
							<tr>
								<td class="buttonRow" align="right" >
									<input type="image" name="_confirm" value="confirm" alt="Confirm" title="Confirm Basic Salary Instruction" src="images/confirm_h.png">
						...
						<c:otherwise>
							<tr>
								<td class="buttonRow" align="right" >
									<input type="image" name="_ok" value="ok" alt="Ok" title="Create Basic Salary Instruction" src="images/ok_h.png">
									<input type="image" name="_cancel" value="cancel" alt="Cancel" title="Cancel" src="images/cancel_h.png">
								</td>
							</tr>
