		...
		<tr>
						...
						<td>
							<div class="navTopBannerAndSignOffLink">
								<span class="navTopSignOff">
									&nbsp;&nbsp;&nbsp;<a href="javascript: self.close ()" title='Sign Off' id="topNavSearchButton1">Close Window</a>
								</span>
							</div>
						</td>
					</tr>
			...
			<tr>
				<td valign="top" class="mainbody" id="mainbody">
     				...
     				<div id="topOfPageBoxedErrorMessage" style="display:${simulationBean.displayErrors}">
