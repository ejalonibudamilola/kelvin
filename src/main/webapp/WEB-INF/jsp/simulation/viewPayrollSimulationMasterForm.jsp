                        ...
                        <tr>
                            <td valign="top" class="mainBody" id="mainbody">
                                ...
                                <table class="reportMain" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top">
											<p class="label">Payroll Simulations</p>
											<display:table name="dispBean" class="register3" export="false" sort="page" defaultsort="1" requestURI="${appContext}/prePayrollSimReportForm.do">
											<display:setProperty name="export.rtf.filename" value="PayrollSimulationsList.rtf"/>
											<display:setProperty name="export.excel.filename" value="PayrollSimulationsList.xls"/>
											<display:column property="name" title="Name" media="html" href="${appContext}/viewSimulatedPayrollResult.do" paramId="pid" paramProperty="id"></display:column>
											...
											<display:column property="details" title="Details" media="html" href="${appContext}/viewPayrollDetails.do" paramId="pid" paramProperty="id"></display:column>
