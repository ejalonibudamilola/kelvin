                ...
                <td>
                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="title">
                                    Deactivate Business Client</div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" class="mainbody" id="mainbody">
                             <p>
                                ...
                                <form:form modelAttribute="deactBean">
									<div id="topOfPageBoxedErrorMessage" style="display:${deactBean.displayErrors}">
								 		<spring:hasBindErrors name="deactBean">
         									 <ul>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="90%" id="pcform0">
                                        <tr>
                                            <td>
                                                <table class="formTable" border="0" cellspacing="0" cellpadding="3" width="100%" align="left">
                                                     <tr align="left">
                                                       <td class="activeTH"> Deactivate Account</td>
                                                    </tr>
                                                     <tr>
                                                        <td class="activeTD">
                                                                        ...
                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                            	<td width="20%" class="required">
                                                                                	...
                                                                                	<td width="80%" nowrap>
                                                                                		<c:choose>
                                                                                		<c:when test="${deactBean.deactivate}">
                                                                                			<form:input path="name" disabled="true"/>
                                                                                		</c:when>
                                                                                		<c:otherwise>
                                                                                		<select name="id" onChange="go(this,'${appContext}/deactivateBusinessClient.do')">
                                                                              ...
                                                                              <td width="20%" class="required">
                                                                              	<span class="required">Deactivation Reason</span>&nbsp;
                                                                              </td>
                                                                              <td width="80%" nowrap>
                                        ...
                                        <tr>
                                            <td class="buttonRow" align="right">
                                                <c:choose>
											<c:when test="${deactBean.deactivate}">
												<input type="image" name="submit" value="deactivate" alt="Deactivate" class="" src="images/deactivate.png">
