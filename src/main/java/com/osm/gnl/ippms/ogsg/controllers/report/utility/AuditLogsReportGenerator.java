...
public class AuditLogsReportGenerator {
...
//             createNewGroupedSheet(data, headers, workbook, groupBy, table_value);
            ...
            //boolean test_subgroup_existing = ;
...
//		sumByGroup(data, headers, workbook, newSheet, subgroupBy, subGroupByValue, rowNo);
        if (totalInd == 1) {
...
//        headerCell4.setCellValue("Print Time: "+currentTime+"");
...
//        Cell headerCell;
    ...
    private void createNewGroupedSheet(List<Map<String, Object>> data, List<Map<String, Object>> headers,
        ...
        addNewSheetTitle(workbook, newSheet, table_value, mainHeaders, table_value);
    ...
    private void createNewGroupedSheetHeaders(Sheet newSheet, Workbook workbook, List<Map<String, Object>> headers) {
        // TODO Auto-generated method stub
        Row headerRow = newSheet.createRow(7);
...
//            cellStyle(workbook, tCell);
    ...
    private boolean test(String table_value) {
        // TODO Auto-generated method stub
        if (tableValues.contains(table_value)) {
            return true;
        } else {
            tableValues.add(table_value);
            return false;
        }
    }
