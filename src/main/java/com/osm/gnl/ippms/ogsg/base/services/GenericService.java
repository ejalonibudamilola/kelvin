...
public class GenericService {
    ...
    public <T> HashMap<Long,T> loadAllObjectsAsMapWithoutRestrictions(final Class<T> pObjectClass, String pMethodName) throws Exception {
         return this.genericDao.loadAllObjectsAsMapWithoutRestrictions(pObjectClass,pMethodName);
    }
    ...
    public <T> boolean isObjectExisting(Class<T> pObjectClass, List<CustomPredicate> customPredicate) {
        return IppmsUtils.isNotNullOrEmpty(this.genericDao.loadAllObjectsUsingRestrictions(pObjectClass,customPredicate, null)) ;
    }
  ...
  public  <T> HashMap<Long, T> loadObjectAsMapWithConditions(final Class<T> pObjectClass, final List<CustomPredicate> predicates, String pMethodName) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    ...
    public void deleteObjectsWithConditions(Class<StepIncreaseBean> stepIncreaseBeanClass, List<CustomPredicate> predicates) {
         this.genericDao.deleteObjectsWithConditions(stepIncreaseBeanClass,predicates);
    }
     ...
     */
    public List<NamedEntity> loadControlObjectByHqlStr(BusinessCertificate businessCertificate, String pHqlStr, boolean pUseParent ){
        return  this.genericDao.loadControlObjectsByIdAndName(businessCertificate,pHqlStr,pUseParent);
    }
