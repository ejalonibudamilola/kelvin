...
@Controller
public class SingleExecutivePayrollSummaryController extends BaseController {
    ...
    private static final String VIEW_NAME = "report/singlePayrollSummaryByClientForm";
    ...
    @RequestMapping({"/singleBusinessExecSummary.do"})
    public String setupForm(@RequestParam("bid")Long bId, @RequestParam("fd") String fromDate, @RequestParam("td") String toDate, Model model, HttpServletRequest request) throws Exception {
        ...
        return doWork(wGuideInfo, bId, model, request, fromDate, toDate);
    }

    public String doWork(ArrayList<String> wGuideInfo, Long bId, Model model,
                         HttpServletRequest request, String fromDate,
                         String toDate) throws IllegalAccessException, InstantiationException {
        ...
        for(String s : wGuideInfo){
            ...
            List<EmployeePayBean> wList = this.paycheckService.loadOneExecEmployeePayBeanByParentIdFromDateToDate(wStartMonth, wStartYear, bId);
            ...
            PayrollRunMasterBean wPRMB = this.genericService.loadObjectUsingRestriction(PayrollRunMasterBean.class, Arrays.asList(
                    ...
                    CustomPredicate.procurePredicate("businessClientId", bId)));
        ...
        wSIC.setFromDateStr(fromDate);
        wSIC.setToDateStr(toDate);
