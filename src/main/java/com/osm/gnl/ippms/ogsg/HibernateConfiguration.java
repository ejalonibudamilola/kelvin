...
public class HibernateConfiguration {
    ...
    public DataSource dataSource() {
       ...
       // dataSource.setIdleTimeout();
        ...
        dataSource.addDataSourceProperty("spring.datasource.hikari.connection-timeout",50000);
        dataSource.addDataSourceProperty("spring.datasource.hikari.idle-timeout",600000);
        dataSource.addDataSourceProperty("spring.datasource.hikari.max-lifetime",1800000);
        dataSource.addDataSourceProperty("spring.datasource.hikari.pool-name","ConnPool");
