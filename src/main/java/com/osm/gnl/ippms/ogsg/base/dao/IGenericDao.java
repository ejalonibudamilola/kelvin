...
public interface IGenericDao {
   ...
   <T> void deleteObjectsWithConditions(Class<T> stepIncreaseBeanClass, List<CustomPredicate> predicates);
     ...
     */
    List<NamedEntity> loadControlObjectsByIdAndName(BusinessCertificate bc, String pHqlStr, boolean pUseParent);
    ...
    <T> HashMap<Long,T> loadAllObjectsAsMapWithoutRestrictions(Class<T> pObjectClass, String pMethodName) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException;
}
