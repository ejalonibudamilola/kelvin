...
@Controller
public class LtgSimulationExcelGenerator {
    ...
    public String generateExcel(WageBeanContainer data, String reportTitle, HttpServletResponse response,
       ...
       // File currDir = new File("src/main/resources/static/images/"+bc.getClientReportLogo());
        ...
        addSheetTitle(sheet, bc, data);

        Row headerRow = sheet.createRow(6);

        createHeaderRow(workbook, headerRow, bc);
...
//			this.p += 1;
        ...
        grandTotals(data, workbook, sheet, startRow);
    }

    private void grandTotals(WageBeanContainer data, Workbook workbook, Sheet sheet, int startRow) {
        Row footer = sheet.createRow(startRow);
        Cell cellFooter = null;
    ...
    private void createHeaderRow(Workbook workbook, Row headerRow, BusinessCertificate bc) {
        // TODO Auto-generated method stub
        ...
        headerCell3.setCellValue("Staff Strength");
        headerCell3.setCellStyle(headerStyle);

        Cell headerCell4= headerRow.createCell(3);
        headerCell4.setCellValue("Salary with LTG Applied");
        headerCell4.setCellStyle(headerStyle);

        Cell headerCell5= headerRow.createCell(4);
        headerCell5.setCellValue("Salary without LTG Applied");
    ...
    private void addSheetTitle(Sheet sheet, BusinessCertificate bc, WageBeanContainer data) {
        // TODO Auto-generated method stub
        ...
        headerCell1.setCellValue(bc.getBusinessName()+ " LTG Simulation Report for "+ data.getMonthAndYearStr() );
