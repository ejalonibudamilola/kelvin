...
@Entity
@Table(name = "ippms_deduction_info_lg")
@SequenceGenerator(name = "empDedInfoSeqLG", sequenceName = "ippms_deduction_info_lg_seq", allocationSize = 1)
@NoArgsConstructor
@Getter
@Setter
public class EmpDeductionInfoLG extends AbstractDeductionEntity {

    private static final long serialVersionUID = 7271242807748610678L;

    @Id
    @GeneratedValue(generator = "empDedInfoSeqLG", strategy = GenerationType.SEQUENCE)
    ...
    public EmpDeductionInfoLG(Long pId, String pDesc) {
        this.id = pId;
        this.description = pDesc;
    }

    public EmpDeductionInfoLG(Long pId) {
        this.id = pId;
    }
